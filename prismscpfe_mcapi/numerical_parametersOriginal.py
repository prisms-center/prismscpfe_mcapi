...
def create_parameters_sample(expt, sample_name=None, verbose=False):
    ...
    parameter_descriptor_list.append(('Order of finite elements', 'int', '1', ''))
    parameter_descriptor_list.append(('Order of quadrature', 'int', '1', ''))
    ...
    parameter_descriptor_list.append(('Write Mesh To EPS', 'bool', 'false', ''))

    parameter_descriptor_list.append(('Write Output', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Output Directory', 'string', '.', ''))
    parameter_descriptor_list.append(('Skip Output Steps', 'int', '-1', ''))

    parameter_descriptor_list.append(('Output Equivalent strain', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Output Equivalent stress', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Output Grain ID', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Output Twin fractions', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Total number of increments', 'int', '-1', ''))  # Actually a list of ints
    parameter_descriptor_list.append(('Maximum linear solver iterations', 'int', '-1', ''))
    parameter_descriptor_list.append(('Relative linear solver tolerance', 'double', '-1', ''))
    parameter_descriptor_list.append(('Maximum non linear iterations', 'int', '-1', ''))
    parameter_descriptor_list.append(('Absolute nonLinear solver tolerance', 'double', '-1', ''))
    parameter_descriptor_list.append(('Relative nonLinear solver tolerance', 'double', '-1', ''))  # Actually a list of strings
    parameter_descriptor_list.append(('Stop on convergence failure', 'bool', 'false', ''))  # Actually a list of strings
    parameter_descriptor_list.append(('Enable adaptive Time stepping', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Adaptive load step factor', 'double', '-1', ''))
    parameter_descriptor_list.append(('Adaptive load increase Factor', 'double', '-1', ''))  # Actually a list of ints
    parameter_descriptor_list.append(('Succesive increment for increasing time step', 'int', '1', ''))
    ...
    parameter_descriptor_list.append(('Number of Slip Systems', 'int', '-1', ''))
    parameter_descriptor_list.append(('Latent Hardening Ratio', 'double', '-1', ''))
    ...
    parameter_descriptor_list.append(('Backstress Factor', 'double', '-1', ''))
    parameter_descriptor_list.append(('Twinning enabled', 'bool', 'false', ''))
    parameter_descriptor_list.append(('Number of Twin Systems', 'int', '-1', ''))
    ...
    parameter_descriptor_list.append(('Characteristic Twin Shear', 'double', '-1', ''))
    parameter_descriptor_list.append(('Twin Saturation Factor', 'double', '-1', ''))
    parameter_descriptor_list.append(('Twin Threshold Fraction', 'double', '-1', ''))
    ...
    parameter_descriptor_list.append(('Stress Tolerance', 'double', '-1', ''))
    parameter_descriptor_list.append(('Max Plastic Slip L2 Norm', 'double', '-1', ''))
    parameter_descriptor_list.append(('Max Slip Search Iterations', 'double', '-1', ''))
    parameter_descriptor_list.append(('Max Solver Iterations', 'double', '-1', ''))
    parameter_descriptor_list.append(('Voxels in X direction', 'int', '-1', ''))
    parameter_descriptor_list.append(('Voxels in Y direction', 'int', '-1', ''))
    parameter_descriptor_list.append(('Voxels in Z direction', 'int', '-1', ''))
    parameter_descriptor_list.append(('Grain ID file name', 'string', 'grainID.txt', ''))
    parameter_descriptor_list.append(('Header Lines GrainID File', 'int', '-1', ''))
